...
import os
from parameters import HORIZON, LOAD_MODEL, TEST_ID, EPISODES, MAP_ID, MAX_AC, ARR_INTERVAL, SEED, MAX_WIND, WIND, ACTIONS, ARR_RATE
...
def init_plugin():
    ...
    arr_rate_arrival = loadDataStr(
        "./routes_james/" + MAP_ID + "/" + "arr_rate_arrival_" + str(HORIZON) + "_" + str(
    ...
    config = {
        ...
        'plugin_name':     'CASE_STUDY_B_NEW_ARR',
