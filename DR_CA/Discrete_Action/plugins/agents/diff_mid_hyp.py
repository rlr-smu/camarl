...
class diff_mid_hyp(syn_data):

    def __init__(self, dir_name=None, pro_folder=None, lg=None):
        super(diff_mid_hyp,  self).__init__(dir_name=dir_name, pro_folder=pro_folder)
...
class diff_mid_hyp_loss_BK(syn_data):

    def __init__(self, dir_name=None, pro_folder=None, lg=None):
        super(diff_mid_hyp_loss_BK,  self).__init__(dir_name=dir_name, pro_folder=pro_folder)
...
class diff_mid_real_hyp(real_real_data):

    def __init__(self, dir_name=None, pro_folder=None, lg=None):
        super(diff_mid_real_hyp,  self).__init__(dir_name=dir_name, pro_folder=pro_folder)
