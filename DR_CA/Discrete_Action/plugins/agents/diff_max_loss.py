...
class diff_max_loss(syn_data):

    def __init__(self, dir_name=None, pro_folder=None, lg=None):
        super(diff_max_loss,  self).__init__(dir_name=dir_name, pro_folder=pro_folder)
    ...
    def train(self, ep=None):
        ...
        y_target = tc.tensor(self.rw_train).float()
        op1 = y_pred - y_target
        op2 = op1 * op1
...
class diff_max_real(real_data):

    def __init__(self, dir_name=None, pro_folder=None, lg=None):
        super(diff_max_real,  self).__init__(dir_name=dir_name, pro_folder=pro_folder)
