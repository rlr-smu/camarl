...
from utils import deleteDir, log, logRunTime, get_one_hot, prep_train_data_dec
import argparse
from environment import environment
from agents.random import random_agent
from agents.vpg import vpg_dec
from agents.idv import idv_dec
...
def init_agent(agent_name, config):
    ...
    agent = None
    if agent_name == "vpg_dec":
        agent = vpg_dec(config=config)
...
def main():
    ...
    for ep in range(1, EPISODES + 1):
        ...
        train_x, train_val, train_nsa, _ = prep_train_data_dec(s_dim, o_dim, buff_ntsa, buff_x, val_fn)
